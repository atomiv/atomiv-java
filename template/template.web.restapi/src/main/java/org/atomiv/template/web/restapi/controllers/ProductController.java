...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<CreateProductCommandResponse> createProduct(@Valid @RequestBody CreateProductCommand command) {
	...
	@GetMapping
	public ResponseEntity<BrowseProductsQueryResponse> browseProducts(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
